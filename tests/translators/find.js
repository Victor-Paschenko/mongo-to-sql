...
describe('Find', () => {
  describe('Translate', () => {
    ...
    it('should return a string of sql request from extracted params', () => {
      let extractor = new Extractor(mocks.SIMPLE_QUERY);
